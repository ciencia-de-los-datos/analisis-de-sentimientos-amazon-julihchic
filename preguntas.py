...
def pregunta_04():
    ...
    # letras.
    countVectorizer = CountVectorizer(analyzer=analyzer4,lowercase=True,stop_words='english',token_pattern=r'(?u)\b[a-zA-Z][a-zA-Z]+\b',binary=True,max_df=1.0,min_df=5)
